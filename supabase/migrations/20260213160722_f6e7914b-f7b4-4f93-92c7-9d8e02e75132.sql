...
INSERT INTO public.categories (name, slug, description, display_order) VALUES
  ('Wooden Doors', 'wooden-doors', 'Premium handcrafted wooden doors for homes and offices', 1),
  ('Wooden Chairs', 'wooden-chairs', 'Comfortable and elegant wooden chairs for every room', 2),
  ('Wooden Tables', 'wooden-tables', 'Sturdy wooden tables for dining, office, and more', 3),
  ('Wooden Beds', 'wooden-beds', 'Solid wood beds crafted for comfort and durability', 4),
  ('Wooden Cabinets', 'wooden-cabinets', 'Spacious wooden cabinets and wardrobes for storage', 5);
