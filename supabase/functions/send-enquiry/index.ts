  ...
  try {
    ...
    const htmlBody = `
      ...
      <table style="border-collapse:collapse;width:100%;max-width:600px;">
        ...
        <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">Product Required</td><td style="padding:8px;border:1px solid #ddd;">${data.product}</td></tr>
        <tr><td style="padding:8px;border:1px solid #ddd;font-weight:bold;">Quantity</td><td style="padding:8px;border:1px solid #ddd;">${data.quantity || "N/A"}</td></tr>
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: ["emmes2010@gmail.com"],
        subject: `New Enquiry: ${data.product} - ${data.name}`,
        html: htmlBody,
      }),
    });
